...
#include "lib/interface_header/IConsoleCommandModule.h"
#include "lib/base_code/util.h"
#include "lib/message/config_define.hpp"
...
#include "lib/log/loglib.h"
#include "lib/config/config.h"
#include "lib/component/component.h"
#include "lib/message/message_lib.h"
#include "lib/db_redis/redis_lib.h"
#include "lib/midware/data_agent/data_agent_lib.h"
#include "lib/http_lib/http_lib.h"
#include "server/master/master_server.h"
#include "server/world/world_server.h"
#include "server/login/login_server.h"
#include "server/game/game_server.h"
#include "server/gate/gate_server.h"
#include "server/log_server/log_server.h"
#include "server/test_server/test_server.h"
...
#pragma comment(lib, "log_server_d.lib")
...
bool LibManager::launch(ILib* lib, SERVER_TYPES server_type, int argc, char* argv[])
{
#if ZQ_PLATFORM == ZQ_PLATFORM_WIN
	WSADATA wsaData;
