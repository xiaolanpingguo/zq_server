...
bool PropertyManager::registerCallback(const std::string& strProperty, PROPERTY_EVENT_FUNCTOR&& cb)
{
...
std::shared_ptr<IProperty> PropertyManager::addProperty(const Guid& self, const std::string& strPropertyName, const EN_DATA_TYPE varType)
{
...
bool PropertyManager::setPropertyObject(const std::string& strPropertyName, const Guid& obj)
{
    std::shared_ptr<IProperty> pProperty = getElement(strPropertyName);
    if (pProperty)
    {
...
const Guid& PropertyManager::getPropertyObject(const std::string& strPropertyName)
{
    std::shared_ptr<IProperty> pProperty = getElement(strPropertyName);
    if (pProperty)
    {
