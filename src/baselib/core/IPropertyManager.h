...
//
//	virtual std::shared_ptr<IProperty> addProperty(const uuid& self, std::shared_ptr<IProperty> pProperty) = 0;
//	virtual std::shared_ptr<IProperty> addProperty(const uuid& self, const std::string& strPropertyName, const EN_DATA_TYPE varType) = 0;
//
//	//virtual const uuid& self() = 0;
//
...
//	virtual bool setPropertyObject(const std::string& strPropertyName, const uuid& obj) = 0;
//
...
//	virtual const uuid& getPropertyObject(const std::string& strPropertyName) = 0;
//};
//
//}
