...
//const static uuid NULL_UUID = uuid();
...
//
//	EN_DATA_TYPE type_;
//	std::variant<int64, double, std::string, uuid> variantData_;
//};
//
...
////	}
////
////	virtual bool add(const uuid& value)
////	{
////		if (GetCount() == (int)(mvList.size()))
////		{
////			AddStatck();
...
////	}
////
////	virtual bool Set(const int index, const uuid& value)
////	{
...
////	}
////
////	virtual const uuid& Object(const int index) const
////	{
////		if (ValidIndex(index))
////		{
...
////		return add(value);
////	}
////	bool AddObject(const uuid& value)
////	{
////		return add(value);
////	}
...
////		return Set(index, value);
////	}
////	bool setObject(const int index, const uuid& value)
////	{
////		return Set(index, value);
////	}
...
////		return *this;
////	}
////	inline DataList& operator<<(const uuid& value)
////	{
////		add(value);
////		return *this;
////	}
